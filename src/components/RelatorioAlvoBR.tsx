...
import { calcularTotais } from "../utils/calculos";
...
export default function RelatorioAlvoBR() {
  ...
  const { totalValor, totalProbabilidade, chancePercentual } = calcularTotais(deals);
    ...
    <div className="p-8 bg-white text-gray-800 font-[Montserrat] min-h-screen">
      <header className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between border-b pb-4 mb-6">
        <div className="flex items-center gap-3">
          <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#00A99D] text-lg font-bold text-white">
            ALVO
          </div>
          <div>
